...
fun main(args: Array<String>) {
    ...
    val bot = bot {
        ...
        dispatch {
            ...
            command("general_notify") { bot, update ->
                val chatId = chatId(update)
    ...
    updater = Updater(connector, bot)
    updater.startAutomaticUpdates()
}

fun chatId(update: Update) = update.message!!.chat.id
